...
class _$NoteWatcherStateTearOff {
  ...
  _LoadInSuccess loadInSuccess(KtList<Note> notes) {
    return _LoadInSuccess(
      notes,
    );
  }

  _LoadInFailure loadInFailure(NoteFailure noteFailure) {
...
mixin _$NoteWatcherState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(KtList<Note> notes) loadInSuccess,
    required TResult Function(NoteFailure noteFailure) loadInFailure,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult Function(KtList<Note> notes)? loadInSuccess,
    TResult Function(NoteFailure noteFailure)? loadInFailure,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
  TResult maybeWhen<TResult extends Object?>({
...
class _$_LoadInSuccess implements _LoadInSuccess {
  const _$_LoadInSuccess(this.notes);
  ...
  @override
  String toString() {
    return 'NoteWatcherState.loadInSuccess(notes: $notes)';
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return loadInSuccess?.call(notes);
  }
...
abstract class _LoadInSuccess implements NoteWatcherState {
  const factory _LoadInSuccess(KtList<Note> notes) = _$_LoadInSuccess;
...
class _$_LoadInFailure implements _LoadInFailure {
  const _$_LoadInFailure(this.noteFailure);
  ...
  @override
  String toString() {
    return 'NoteWatcherState.loadInFailure(noteFailure: $noteFailure)';
  }
  ...
  TResult when<TResult extends Object?>({
    ...
    return loadInFailure(noteFailure);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return loadInFailure?.call(noteFailure);
  }
...
abstract class _LoadInFailure implements NoteWatcherState {
  const factory _LoadInFailure(NoteFailure noteFailure) = _$_LoadInFailure;
